...
RSpec.describe AvailabilityService::Create, type: :model do
  ...
  it 'returns error when it is a sunday' do
    ...
    expect { AvailabilityService::Create.new(fp_id: dummy_id, from: from).execute }.to raise_error(Availability::BadFromError)
  end
  ...
  it 'creates availability when from begins at the hour for a weekday' do
    ...
    AvailabilityService::Create.new(fp_id: dummy_id, from: from).execute
