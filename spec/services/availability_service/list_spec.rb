...
RSpec.describe AvailabilityService::List, type: :model do
  ...
  it 'returns 2 availabilities' do
    Availability.create(user_id: dummy_id, from: from.change(day: 12, month: 10, year: 2020, hour: 11, min: 0))
    Availability.create(user_id: dummy_id, from: from.change(day: 12, month: 10, year: 2020, hour: 17, min: 0))
