...
RSpec.describe "/availabilities", type: :request do
  ...
  # AvailabilitiesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get availabilities_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new Availability" do
        expect {
          post availabilities_url,
               params: { availability: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      ...
      it "renders a JSON response with errors for the new availability" do
        post availabilities_url,
             params: { availability: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested availability" do
      availability = Availability.create! valid_attributes
      expect {
        delete availability_url(availability), headers: valid_headers, as: :json
      }.to change(Availability, :count).by(-1)
    end
  end
end
